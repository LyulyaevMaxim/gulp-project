"use strict";
const COLOR_ORANGE = "#FF7F00";   //обозначение для константы
...
alert(typeof COLOR_ORANGE) // => "string"
...
switch (arg) {
  ...
  case 3: //так как prompt возвращает "3", а  не 3
...
function showMessage(from, text) {  //если во 2й параметр ничего не передано  
  if (text === undefined) {
...
ask(
  "Вы согласны?",
  function () { alert("Вы согласились."); },         //анонимная функция №1
  function () { alert("Вы отменили выполнение."); }  //анонимная функция №2
);
