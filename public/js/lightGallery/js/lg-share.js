        ...
        setTimeout(function() {
          $("#lg-share-facebook").attr(
            ...
            "https://www.facebook.com/sharer/sharer.php?u=" +
              encodeURIComponent(
                _this.core.$items.eq(index).attr("data-facebook-share-url") ||
          ...
          $("#lg-share-twitter").attr(
            ...
            "https://twitter.com/intent/tweet?text=" +
              _this.core.$items.eq(index).attr("data-tweet-text") +
              "&url=" +
              encodeURIComponent(
                _this.core.$items.eq(index).attr("data-twitter-share-url") ||
                  window.location.href
              )
          );
          ...
          $("#lg-share-googleplus").attr(
            ...
            "https://plus.google.com/share?url=" +
              encodeURIComponent(
                _this.core.$items.eq(index).attr("data-googleplus-share-url") ||
                  window.location.href
              )
          );
          ...
          $("#lg-share-pinterest").attr(
            ...
            "http://www.pinterest.com/pin/create/button/?url=" +
              encodeURIComponent(
                _this.core.$items.eq(index).attr("data-pinterest-share-url") ||
                  window.location.href
              ) +
              "&media=" +
              encodeURIComponent(
              ...
              "&description=" +
              _this.core.$items.eq(index).attr("data-pinterest-text")
          );
        }, 100);
      });
    };
